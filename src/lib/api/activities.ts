...
export const activitiesApi = {
  ...
  async get(id: string): Promise<Activity> {
    return await pb.collection('activities').getOne(id) as unknown as Activity;
  },

  // Create activity
  async create(data: Partial<Activity>): Promise<Activity> {
    return await pb.collection('activities').create(data) as unknown as Activity;
  },

  // Update activity
  async update(id: string, data: Partial<Activity>): Promise<Activity> {
    return await pb.collection('activities').update(id, data) as unknown as Activity;
  },
